...
class MainNode(Node):
    ...
    def thread_main(self):
        ...
        while not self.thread_exited:
            ...
            joint_state.name = ['fr_joint', 'fl_joint', 'br_joint', 'bl_joint']
            joint_state.position =  [self.velocity_front_right, self.velocity_front_left,
                                    self.velocity_rear_right, self.velocity_rear_left]
